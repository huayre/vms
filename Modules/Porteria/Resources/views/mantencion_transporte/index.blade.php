    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Mantención de transporte</li>
            </ol>
        </div>
    </div>
@endsection
                    ...
                    <form  method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 form-group align-self-end">
                                ...
                                <button type="button" class="btn btn-sm btn-success" id="nuevo" data-toggle='modal' data-target='#modal-crear-transporte'><i class="fas fa-plus"></i> Nuevo</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="card-body">
                    <table class="table table-striped table-bordered text-sm" id="table-rol">
                        ...
                        <tr>
                            <td>J00203944</td>
                            <td>
                                <button type="button" class="btn btn-sm btn-info mt-1" id="editar" data-toggle='modal' data-target='#modal-editar-transporte'><i class="fas fa-edit"></i> Editar</button>
    ...
    <script>
        function AlertaEliminar()
        {
            Swal.fire({
                ...
                text: "No volveras a usar este Transporte!",
                icon: 'warning',
