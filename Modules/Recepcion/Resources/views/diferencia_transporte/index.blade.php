...
@section('header_content')
    @include('recepcionarticulos::diferencia_transporte.modal_detalle')
    <div class="row mb-2">
        <div class="col-sm-6">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Diferencia en Transporte</li>
            </ol>
        </div>
    </div>
@endsection
        ...
        <div class="col-md-12">
            <div class="card card-dark">
                <div class="card-header">
                    <h3 class="card-title">Buscar Diferencia Carga vs  Descarga transporte</h3>
                </div>
                <div class="card-body">
                    <form  method="post">
                        @csrf
