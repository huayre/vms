...
@section('header_content')
    @include('administracion::articulos.modal_agregar')
    @include('administracion::articulos.modal_editar')
    <div class="row mb-2">
        <div class="col-sm-6">
                    ...
                    <form  method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 form-group align-self-end">
                                ...
                                <button type="button" class="btn btn-sm btn-success" id="nuevo" data-toggle='modal' data-target='#modal-crear-articulos'><i class="fas fa-plus"></i> Nuevo</button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="card card-dark">
                ...
                <div class="card-body">
                    <table class="table table-striped table-bordered text-sm" id="table-rol">
                        ...
                        <tr>
                            <td>J00203944</td>
                            <td>DESARMADOR J4 COLOR NEGRO</td>
                            <td>
                                <button type="button" class="btn btn-sm btn-info mt-1" id="editar" data-toggle='modal' data-target='#modal-editar-articulos'><i class="fas fa-edit"></i> Editar</button>
    ...
    <script>
        function AlertaEliminar()
        {
            Swal.fire({
                ...
                text: "No volveras a usar este artículo!",
                icon: 'warning',
